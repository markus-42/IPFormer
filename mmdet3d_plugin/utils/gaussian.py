...
def generate_guassian_depth_target(depth, stride, cam_depth_range, constant_std=None):
    ...
    dist = Normal(min_depth / cam_depth_range[2], std_var / cam_depth_range[2])
    cdfs = []
    for i in x:
        cdf = dist.cdf(i)
        cdfs.append(cdf)
