...
train_pipeline = [
    ...
    dict(type='CollectData', keys=['class_meta','img_inputs', 'gt_occ','semantic_label', 'instance_label', 'mask_label'], #, 'semantic_label', 'instance_label', 'mask_label'
...
evaluator = dict( # PSCMetrics
  ...
  class_names = ['empty', 'car', 'bicycle', 'motorcycle', 'truck', 'other-vehicle', 'person', 'bicyclist',
                ...
                'vegetation', 'trunk', 'terrain', 'pole', 'traffic-sign'], # 0 to 19
...
test_pipeline = [
    ...
    dict(type='CollectData', keys=['class_meta','img_inputs', 'gt_occ','semantic_label', 'instance_label', 'mask_label'],  
            meta_keys=['pc_range', 'occ_size', 'sequence', 'frame_id', 'raw_img', 'stereo_depth', 'focal_length', 'baseline', 'img_shape', 'gt_depths'])
]
...
_panoptic_query_init_ = "query_from_context_plus_random_init"  # Options: "query_random_init" or "query_from_context" or "query_from_context_plus_random_init" or "query_from_visible_and_invisible"
dustbin_class=False
...
model = dict(
    ...
    class_freq = semantic_kitti_class_frequencies,
    img_backbone=dict(
...
training_steps= max_epochs*4649 #epochs*(iteration/epoch)
